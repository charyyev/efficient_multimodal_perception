...
point_cloud_range = [-19.95, -19.95, -4.95, 19.95, 19.95, 2.95]
number_of_sweeps = 0  # Extra sweeps to be merged. Max is 9 extra.
...
train_pipeline = [
    ...
    dict(type='Collect3D', 
         keys=['range_image', 'img', 'gt_bboxes_3d', 'gt_labels_3d'],
         meta_keys=['camera_intrinsics', 'camera2ego', 'lidar2ego',
                    'lidar2camera', 'camera2lidar', 'lidar2image', 
                    'img_aug_matrix', 'range_points', 'elevation', 'elevation_mask',
                    'occupancy'],
         )
]
test_pipeline = [
