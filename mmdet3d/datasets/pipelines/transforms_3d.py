...
class ImageAug3D:
    """Augment the multi-view images.

    
    Args:
        final_dim (list): Final spatial dimension of images
        resize_lim (float): Resize ratio
        bot_pct_lim (float): Crop limit for bottom of image
        rand_flip (bool): Whether to flip the image
    ...
    def sample_augmentation(self, results):
        ...
        Returns:
            ...
            resize_dims (list): Resize dimensions
            crop (list): Rropping coordinates
    ...
    def img_transform(
        ...
        Args:
            ...
            resize (float): Resize ratio
            resize_dims (list): Resize dimensions
            crop (list): Cropping coordinates
            flip (bool): Whether to flip the image

        Returns:
            img (Image): Updated image
            rotation (np.array): Updated rotation matrix.
            translation (np.array): Updated translation matrix
        """
    ...
    def __call__(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Args:
            data (dict): Data dict from loading pipeline.

        Returns:
            data (dict): Updated data dict from loading pipeline.
        """
        imgs = data["img"]
        new_imgs = []
        imgs_aug = []
...
class ImageNormalize:
    """Normalize image with imagenet mean and std.
        ...
        Args:
            mean (torch.tensor): Mean of imagenet images.
            std (torch.tensor): Std of imagenet images.
    """
